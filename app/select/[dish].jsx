    ...
    <ScrollView className="bg-white ">
      ...
      {error ? (
        ...
        <>
          ...
          <Text className="w-[64%] text-slate-400 mt-4 px-6 ">
          ...
          <ImageBackground
            ...
            className=" absolute right-[-100px]  w-[350px] h-[200px] object-scale-cover rounded-lg top-[80px]"
          />
          ...
          <Text className="px-6 mt-10 mb-5 text-2xl font-bold">Appliances</Text>
          <View className="px-6 flex flex-row ">
            {itemDets.ingredients.appliances.map((app ,i) => {
              return (
                <View key = {i} className="mr-4  bg-slate-100 p-2 rounded-lg">
